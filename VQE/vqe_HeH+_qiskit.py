...
H2_HAMILTONIAN = {
    "II": -0.5916617947447496,
    "XX":  0.08646088000159731,
    "YY":  0.08646088000159731,
    "ZI":  1.2888642482175958,
    "IZ":  0.6737229634183455,
}

EXACT_GROUND_STATE_ENERGY = -2.84138248982841  # Ha
...
if __name__ == "__main__":
    ...
    EXACT_GROUND_STATE_ENERGY = exact["ground_state_energy"]
    print("VQE for HeH+ Molecule Ground State")
    print("=" * 50)

    print(f"Classical reference:")
    print(f"  Ground state energy: {EXACT_GROUND_STATE_ENERGY:.6f} Ha")
